package com.billcom.changecontractstatus.service;
...
public class ThreadService{
    ...
    public int startNewThread() {
        ...
        streamsbuilder.stream(Extern.getTopicThis(), Consumed.with(Serdes.String(), Serdes.String())).foreach(service::exceptionHandler);
