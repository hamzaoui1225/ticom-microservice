...
@AllArgsConstructor
@NoArgsConstructor
public class OrderProcessHistDTO {
    ...
    @JsonIgnore
    public OrderProcessHistDTO(String microservice, String topic, String commandId, String description, String status,String actionCode){
