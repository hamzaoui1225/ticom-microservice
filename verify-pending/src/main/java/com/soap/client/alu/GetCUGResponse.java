...
public class GetCUGResponse  extends OperationResponse implements java.io.Serializable {
    private CUGBean[] cug;
     ...
     * @param cug
     */
    public void setCug(CUGBean[] cug) {
        this.cug = cug;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCug() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getCug(), i);
                if (obj != null &&
