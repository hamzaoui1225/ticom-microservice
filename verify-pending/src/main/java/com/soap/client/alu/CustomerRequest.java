...
public class CustomerRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the csId value for this CustomerRequest.
     * 
     * @return csId
     */
    public Long getCsId() {
    ...
    /**
     * Sets the csId value for this CustomerRequest.
     * 
     * @param csId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alu.services.ws.lhs.com", "CustomerRequest"));
