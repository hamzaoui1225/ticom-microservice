...
public class GetContractListForCustomerResponse  extends OperationResponse implements java.io.Serializable {
    private GetContractListForCustomerBean[] contracts;
    ...
    public GetContractListForCustomerResponse(
           ...
           GetContractListForCustomerBean[] contracts) {
        super(
            bscsErrorCode,
            comment,
            isSuccessful);
     ...
     * @return contracts
     */
    public GetContractListForCustomerBean[] getContracts() {
        return contracts;
    }
     ...
     * @param contracts
     */
    public void setContracts(GetContractListForCustomerBean[] contracts) {
        this.contracts = contracts;
    }
