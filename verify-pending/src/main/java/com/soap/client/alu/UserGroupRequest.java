...
public class UserGroupRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the userName value for this UserGroupRequest.
     * 
     * @return userName
     */
    ...
    /**
     * Sets the userName value for this UserGroupRequest.
     * 
     * @param userName
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alu.services.ws.lhs.com", "UserGroupRequest"));
