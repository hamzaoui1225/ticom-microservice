...
public class ContractListResponse  extends OperationResponse implements java.io.Serializable {
    ...
    public ContractListResponse(
           ...
           ContractsSearchBeanOut contractList) {
        super(
            bscsErrorCode,
            comment,
            isSuccessful);
     ...
     * @return contractList
     */
    public ContractsSearchBeanOut getContractList() {
        return contractList;
    }
     ...
     * @param contractList
     */
    public void setContractList(ContractsSearchBeanOut contractList) {
        this.contractList = contractList;
    }
