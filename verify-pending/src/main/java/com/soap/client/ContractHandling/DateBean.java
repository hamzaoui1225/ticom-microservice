...
public class DateBean  extends BaseSOIBean implements java.io.Serializable {
    ...
    /**
     * Gets the date value for this DateBean.
     * 
     * @return date
     */
    ...
    /**
     * Sets the date value for this DateBean.
     * 
     * @param date
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alu.services.ws.lhs.com", "DateBean"));
