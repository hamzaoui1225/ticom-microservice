...
public class CheckRateplanResponse  extends OperationResponse implements java.io.Serializable {
    private Reference[] incompatibleServices;

    private Boolean isCompatible;

    private Reference[] missingServices;
    ...
    public CheckRateplanResponse(
           ...
           Reference[] incompatibleServices,
           Boolean isCompatible,
           Reference[] missingServices) {
        super(
            bscsErrorCode,
            comment,
            isSuccessful);
     ...
     */
    public Reference[] getIncompatibleServices() {
        return incompatibleServices;
    }
     ...
     */
    public void setIncompatibleServices(Reference[] incompatibleServices) {
        this.incompatibleServices = incompatibleServices;
    }
     ...
     */
    public Reference[] getMissingServices() {
        return missingServices;
    }
     ...
     */
    public void setMissingServices(Reference[] missingServices) {
        this.missingServices = missingServices;
    }
