...
public class ConsoDataHistoryResponse  extends OperationResponse implements java.io.Serializable {
    private ConsoDataDetails[] consoDataHistory;
    ...
    public ConsoDataHistoryResponse(
           ...
           ConsoDataDetails[] consoDataHistory) {
        super(
            bscsErrorCode,
            comment,
            isSuccessful);
     ...
     */
    public ConsoDataDetails[] getConsoDataHistory() {
        return consoDataHistory;
    }
     ...
     */
    public void setConsoDataHistory(ConsoDataDetails[] consoDataHistory) {
        this.consoDataHistory = consoDataHistory;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getConsoDataHistory() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getConsoDataHistory(), i);
                if (obj != null &&
