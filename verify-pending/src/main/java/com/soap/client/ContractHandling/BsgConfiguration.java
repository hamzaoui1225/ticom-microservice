...
public class BsgConfiguration  extends BaseSOIBean implements java.io.Serializable {
    private Long bsgId;

    private Long preferedCugId;
     ...
     * @param preferedCugId
     */
    public void setPreferedCugId(Long preferedCugId) {
        this.preferedCugId = preferedCugId;
    }
