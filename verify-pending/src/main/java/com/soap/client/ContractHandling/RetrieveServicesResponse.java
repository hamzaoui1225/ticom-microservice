...
public class RetrieveServicesResponse  extends OperationResponse implements java.io.Serializable {
    private Long contractID;

    private Service[] detailedServices;
     ...
     */
    public Service[] getDetailedServices() {
        return detailedServices;
    }
     ...
     */
    public void setDetailedServices(Service[] detailedServices) {
        this.detailedServices = detailedServices;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getDetailedServices() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getDetailedServices(), i);
                if (obj != null &&
